...
#define INF_VERSION_RTYPE 2
#define INF_VERSION_HTFIX 0

#define INF_FILE_VERSION_ARR INF_VERSION_MAJOR,INF_VERSION_MINOR,INF_VERSION_RTYPE,INF_VERSION_HTFIX
#define INF_FILE_VERSION_STR TO_STRING2(INF_VERSION_MAJOR) "." TO_STRING2(INF_VERSION_MINOR) "." TO_STRING2(INF_VERSION_RTYPE) "." TO_STRING2(INF_VERSION_HTFIX)
